...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/asset-library': { section: 'console', module: 'assets' },
 ...
 *      UI to restore.
 *
 * Account capability switches (asset_library_enabled / asset_upload_enabled)
 * deliberately do NOT participate here: they gate functions inside the asset
 * library page, not the module entry itself.
 */
