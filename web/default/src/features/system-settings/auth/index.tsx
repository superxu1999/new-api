...
const defaultAuthSettings: AuthSettings = {
  ...
  'sms.enabled': false,
  'sms.login_enabled': false,
  'sms.register_enabled': false,
  'sms.provider': 'disabled',
  'sms.generic_url': '',
  'sms.generic_method': 'POST',
  'sms.generic_template': '',
  'sms.aliyun_access_key_id': '',
  'sms.aliyun_access_secret': '',
  'sms.aliyun_sign_name': '',
  'sms.aliyun_template_code': '',
  'sms.tencent_secret_id': '',
  'sms.tencent_secret_key': '',
  'sms.tencent_sdk_app_id': '',
  'sms.tencent_sign_name': '',
  'sms.tencent_template_id': '',
